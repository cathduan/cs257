...
with open('MetObjects.csv') as original_data_file,\
        open('artworks.csv', 'w') as linking_table_file:
    reader = csv.reader(original_data_file)
    ...
    for row in reader:
        ...
        writer.writerow([linking_table_id, artwork_name, object_date, collection_id, material_id, geographical_location_id, geography_type_id, artist_id, link_resource])
