...
function initialize() {
    ...
    .then(function(artist_list) {
        ...
        artist_info_div = '<div id = "image-page"> <div class="current-image"> <img src = "wombat.jpg"  alt = "a wombat strolling over to you">  </div> <div class = "image-detail"> Artist Bio: ' + artist_list[98]['artist_bio'] + '</div> <div class = "image-detail">' + artist_list[98]['artist_birthyear'] + '-' + artist_list[98]['artist_deathyear'] + '</div> <div class = "image-detail"> # of works at the MET:</div> </div>';
